...
|------|-------|------|-------|
| `gen_nasm/__init__.py` | 69 | 10 | 86%|
| `gen_nasm/pro/__init__.py` | 57 | 0 | 100%|
| `gen_nasm/pro/read_template.py` | 51 | 0 | 100%|
| `gen_nasm/pro/write_template.py` | 58 | 1 | 98%|
| **Total** | 235 | 11 | 95% |
...
Copyright (C) 2024 - 2026 by [vroncevic.github.io/gen_nasm](https://vroncevic.github.io/gen_nasm/)
