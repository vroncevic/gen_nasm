...
def main() -> bool:
    '''
        Bootstraps and runs the gen_nasm with required adapters.

        :return: True if successful, False otherwise.
        :exceptions: None
    '''
    gen_nasm: GenNasm = GenNasm(GenNasmBundleFactory.create_bundle())

    return gen_nasm.process()


if __name__ == '__main__':
    '''
        Entry point for gen_nasm execution.
