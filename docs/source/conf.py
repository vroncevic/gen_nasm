...
htmlhelp_basename: str = 'gen_nasmdoc'
latex_elements: Dict[Any, Any] = {}
latex_documents: List[Tuple[Any, ...]] = [(
    master_doc, 'gen_nasm.tex', 'gen\\_autoconf Documentation',
    'Vladimir Roncevic \\textless{}elektron.ronca@gmail.com\\textgreater{}',
    'manual'
)]
man_pages: List[Tuple[Any, ...]] = [(
    master_doc, 'gen_nasm', 'gen_nasm Documentation', [author], 1
)]
texinfo_documents: List[Tuple[Any, ...]] = [(
    master_doc, 'gen_nasm', 'gen_nasm Documentation', author,
    'gen_nasm', 'One line description of project.', 'Miscellaneous'
)]
