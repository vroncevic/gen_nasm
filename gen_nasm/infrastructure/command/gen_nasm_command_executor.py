...
Info
    Defines GenNasmCommandExecutor class.
'''
...
class GenNasmCommandExecutor:
    '''
        Command executor strategy for generating nasm project files.
        ...
        It defines:
            ...
            :methods:
                ...
                | __str__ - Returns the GenNasmCommandExecutor as string representation.
    '''
    ...
    def __str__(self) -> str:
        '''
            Returns the GenNasmCommandExecutor as string representation.

            :return: The GenNasmCommandExecutor as string representation.
        '''
        return to_str(self)
