...
from gen_nasm.infrastructure.cli.setup.opt_validator import CLIBundleOptionsValidator
from gen_nasm.infrastructure.cli.setup.bundle import CLIBundle
from gen_nasm.infrastructure.cli.setup.keys import CLIBundleKeys
...
from gen_nasm.infrastructure.command.icommand_definition import ICommandDefinition
from gen_nasm.infrastructure.command.icommand_executor import ICommandExecutor
...
class CLIBundleFactory:
    ...
    def create_bundle(cls, options: CLIBundleOptions) -> CLIBundle:
        ...
        service_definition: ICommandDefinition = GenNasmCommandDefinition()
        service_executor: ICommandExecutor = GenNasmCommandExecutor(definition=service_definition)
