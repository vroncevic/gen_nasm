...
Info
    A validator for the gen_nasm bundle.
'''
...
class GenNasmBundleValidator:
    ...
    @classmethod
    def validate(cls, bundle: GenNasmBundle) -> None:
        '''
            Validates the gen_nasm bundle.

            :param bundle: The gen_nasm bundle to be validated.
            :exceptions:
        ...
        '''
        ctx: str = 'gen_nasm_bundle_validator::validate(...)'
        msg_bundle_none: str = 'the gen_nasm bundle must be provided'
        msg_bundle_istype: str = 'the gen_nasm bundle must be an instance of GenNasmBundle'
        ...
        istype(bundle, GenNasmBundle, ctx, msg_bundle_istype)
