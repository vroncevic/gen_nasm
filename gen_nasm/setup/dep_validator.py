...
Info
    Validator for the gen_nasm bundle dependencies.
'''
...
class GenNasmBundleDependenciesValidator:
    '''
        Validator for the gen_nasm bundle dependencies.
    ...
    @classmethod
    def validate(cls, dependencies: GenNasmBundleDependencies) -> None:
        '''
            Validates the gen_nasm bundle dependencies.

            :param dependencies: The gen_nasm bundle dependencies to be validated.
            :exceptions:
        ...
        '''
        ctx: str = 'gen_nasm_bundle_dependencies_validator::validate(...)'
        msg_dependencies_none: str = 'the gen_nasm bundle dependencies must be provided'
        msg_dependencies_istype: str = 'the gen_nasm bundle dependencies must be a Mapping'

        not_none(dependencies, ctx, msg_dependencies_none)
        istype(dependencies, Mapping, ctx, msg_dependencies_istype)

        for attr_name, expected_type in GenNasmBundleKeys.get_dependency_to_type().items():
