...
Info
    ...
    Creates test cases for checking functionalities of GenNASMPro.
Execute
    python3 -m unittest -v gen_nasm_pro_test
'''
...
class GenProTestCase(TestCase):
    ...
    def test_default_create(self) -> None:
        ...
        generator: GenNASMPro = GenNASMPro()
